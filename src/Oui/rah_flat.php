...
"download":https://github.com/gocom/NicolasGraph/rah_flat the plugin, paste it under the textpattern plugin tab, and upload it.
...
rah_flat comes with built-in support for a few essential content types: variables (via custom prefs), styles, forms, pages, preferences and sections. See the "templates":https://github.com/gocom/rah_flat/tree/master/templates directory on GitHub for an example how this all works.
